	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float temp_output_15_0 = ( 1.0 - IN.ase_color.r );
				float mulTime24 = _TimeParameters.x * 30.0;
				float lerpResult19 = lerp( ( IN.ase_color.r * IN.ase_color.r * IN.ase_color.r ) , ( temp_output_15_0 * temp_output_15_0 * temp_output_15_0 * temp_output_15_0 ) , (0.0 + (cos( mulTime24 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Color * lerpResult19 ).rgb;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-838.6044,-259.3523;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;14;-1224.657,-494.3174;Inherit;False;Property;_Color;Color;0;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;19;-976.7686,-12.54225;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;10;-2083.112,-219.379;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;15;-1850.534,-16.36134;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-1655.296,-14.40705;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-1663.179,-250.1819;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;23;-1469.318,434.3434;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CosOpNode;22;-1717.72,451.489;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;24;-1956.141,250.3823;Inherit;False;1;0;FLOAT;30;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=7FB5EC4EC468A875AAC69F8F29CA19167C9B7763